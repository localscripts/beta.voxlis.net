const expData = [
  ...
  },
  {
    ...
    txtColor: "text-red-500",
    accentColor: "from-red-600 to-red-700",
    info: "## Exploit Performance  \n- [Swift](/) performs well for a free exploit, although some users may experience occasional issues with its keysystem. While alternatives like [Atlantis]() and [Argon]() exist, they aren't as trusted or reputable as [Swift]().\n\n## Background Information  \n- [Swift](/), originally known as [bunni.lol](/), launched in May 2024. After facing initial challenges, it rebranded to Swift in August 2024 and entered its Beta phase. Since then, it has gained a solid reputation for delivering a premium-like experience at no cost.\n\n- In January 2025, [Swift](/) was temporarily taken offline due to a major Roblox platform update. It returned in March 2025 with a major overhaul that introduced 98% sUNC compatibility, a built-in decompiler, and several quality-of-life improvements.\n\n## Developer Background  \n- The [Swift](/) development team has evolved significantly over time. Its current lead developer, [Peyton](/), has a strong history of leading successful projects. [Bass](/), a well-known cheat reseller and former member of the [Script-Ware]() team, later joined as a core contributor.\n\n- [Swift]() has also collaborated with external developers for specific features. For example, error handling was developed by [Zenith’s]() team, while UI design was handled by a designer named [Blinx]().\n\n> Sources: r/robloxhackers, bunni.lol Discord Archives, Swift Discord Archives\n",
    premium: true,
