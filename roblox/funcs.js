const expData = [
  ...
  },
  {
    ...
    neutral: [],
    cons: ["Owned by ArceusX developers"],
    verified: true,
    editor: "voxlis.NET",
  ...
  },
  {
      id: "arceusx",
      name: "ArceusX NEO",
      desc: "A long-standing mobile exploit with high UNC percentage.",
      lvl: 8,
      price: "FREE",
      plat: ["ios", "android", "ios", "android"],
      pros: ["98% UNC~", "Level 8", "VNG Support"],
      neutral: ["Similar to CodeX", "Long keysystem", "Owned by Wave devs"],
      cons: ["Stole user data in 2021"],
      verified: false,
      editor: "vonpix",
      txtColor: "text-yellow-500",
      accentColor: "from-yellow-600 to-yellow-700",
      info: "## Exploit Peformance\n- ArceusX can run most scripts because of its high UNC percentage. But functions such as \"getinstance\" aren't available.\n\n- In addition, there are better alternatives like [KRNL](krnl.cat) and [Delta](deltaexploits.gg) which have slightly better UNC and have a better background in terms of safety.\n\n## Background Information\n- ArceusX was released in 2019 as one of the first executors for mobile.\n\n- In March 2022, [@lxnny](/) — the owner of [Delta](deltaexploits.gg) — reposted the CW (community warning) on [WeAreDevs](wearedevs.net), exposing ArceusX for ratting users and massively scamming their developers.\n\n- Despite this, ArceusX remains a prominently used executor to date.\n\n- In April 2024, SPDMTeam launched [Wave](getwave.gg) (basically ArceusX and CodeX combined for Windows with a nicer UI). It is currently trusted by most people, however still owned by the same developers who stole data.\n\n- Currently despite [Wave](getwave.gg)'s release, ArceusX still receives regular updates to this day.\n\n## Developers Background Information\n\n- Owned by [Tiahh](/) and [SPDMTeam](spdmteam.com), there isn't much info on the developer's background.",
      premium: false,
      href: "https://spdmteam.com/",
      priceHref: "https://yap.com/",
      hide: false,
      warning: true,
      warningInfo: "Has a past of stealing user data in 2021.",
  },
  {
    id: "nezur",
    name: "Nezur",
