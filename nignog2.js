const expData = [
    ...
    },
  {
    ...
    info: "## Exploit Experience  \n- [Wave](/) works as expected, offering a smooth and stable experience with a solid update schedule.  \n  While this used to be a standout feature, most exploits now pre-update, making it less unique.  \n  The UI is clean and user-friendly. One notable downside is that whenever [Wave](/) updates, it automatically deletes your AutoExec folder and related files. Additionally, tabs don’t save, which can be inconvenient. On the bright side, [Wave](/) comes as a single `.exe` file, unlike many other exploits that are bundled in `.zip` archives with multiple `.dll` files.  \n\n\n## General Information  \n- In March 2022, [@lxnny]() — the owner of Delta reposted the CW (community warning) on [WeAreDevs.NET](https://forum.wearedevs.net/t/25074), exposing [ArceusX]() for allegedly ratting users and scamming their developers.\n- Originally, [Wave's]() launch was delayed and teased multiple times in their Discord server.  \n  It eventually released around April 5–9, but saw very few updates early on.  \n  For example, when Roblox updated on a Wednesday, Wave wouldn't get updated until Friday.  \n  This pattern continued up until December 2024, sometimes with even bigger delays.  \n\n- Since December, [Wave]() has shown better performance and has been more consistent.  \n  However, the UI and other features haven't seen much attention or updates since then.  \n\n\n## Developers Background Information  \nHoly shit i am so cooked, i have so many things to reseach - voxlis.NET\n",
    hide: false,
  },
  {
    id: "macsploit",
